...
abstract class $TodoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String todoName, bool isDone});
}
...
class _$_TodoModel with DiagnosticableTreeMixin implements _TodoModel {
  const _$_TodoModel({this.todoName = '', this.isDone = false});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TodoModel(todoName: $todoName, isDone: $isDone)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('todoName', todoName))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, todoName, isDone);
...
abstract class _TodoModel implements TodoModel {
  const factory _TodoModel({final String todoName, final bool isDone}) =
      _$_TodoModel;
